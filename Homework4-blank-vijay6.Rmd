...
The Null Hypothesis is : Ho : uqueenlog — pworkerlog = 0 , i.e) the difference between the transformed (logit) means of the pollens removed by the mean Queen bees and Worker bees is 0.
...
Also the p value is less than alpha. So we reject the Null hypothesis that the difference in means of logs of the pollens removed by the Queen and Worker bees is 0 in favor of the alternative hypothesis at alpha = 0.05 since our p value is less than alpha.
